...
#include "quakedef.h" // Baker: Modifications = masked alpha model support and THAT'S ALL and ONLY.
...
int	r_p0[6] /* qasm */, r_p1[6] /* qasm */, r_p2[6] /* qasm */;

byte		*d_pcolormap /* qasm */;
...
int				a_sstepxfrac /* qasm */, a_tstepxfrac /* qasm */, r_lstepx /* qasm */, a_ststepxwhole /* qasm */;
int				r_sstepx /* qasm */, r_tstepx /* qasm */, r_lstepy /* qasm */, r_sstepy /* qasm */, r_tstepy /* qasm */;
int				r_zistepx /* qasm */, r_zistepy /* qasm */;
int				d_aspancount /* qasm */, d_countextrastep  /* qasm */;

spanpackage_t			*a_spans /* qasm */;
spanpackage_t			*d_pedgespanpackage /* qasm */;
static int				ystart;
byte					*d_pdest /* qasm */, *d_ptex /* qasm */;
short					*d_pz /* qasm */;
int						d_sfrac /* qasm */, d_tfrac /* qasm */, d_light /* qasm */, d_zi /* qasm */;
int						d_ptexextrastep /* qasm */, d_sfracextrastep /* qasm */;
int						d_tfracextrastep /* qasm */, d_lightextrastep /* qasm */, d_pdestextrastep /* qasm */;
int						d_lightbasestep /* qasm */, d_pdestbasestep /* qasm */, d_ptexbasestep /* qasm */;
int						d_sfracbasestep /* qasm */, d_tfracbasestep /* qasm */;
int						d_ziextrastep /* qasm */, d_zibasestep /* qasm */;
int						d_pzextrastep /* qasm */, d_pzbasestep /* qasm */;
...
byte	*skintable[MAX_LBM_HEIGHT] /* qasm */;
int		skinwidth;
byte	*skinstart;
...
#if 0
byte gelmap[PALETTE_COLORS_256];
...
void D_PolysetDrawSpans8 (spanpackage_t *pspanpackage)
{
	...
	int		lzi;
	short	*lpz;
	cbool	ismasked = pmdl->flags & EF_ALPHA_MASKED_MDL; // EF_ALPHA_MASKED_MDL
...
================
*/
void D_RasterizeAliasPolySmooth (void) /* qasm */
{
...
#pragma message ("Baker: Tune against rare crash here where count == 0; MH says solution is never to trivially accept")
		if (1) //pstart->count)
		{
			...
			D_PolysetDrawSpans8 (pstart); // Masked texture or not, C pathway = slower.
		}
	}
}
...
================
*/
void D_PolysetSetEdgeTable (void) /* qasm */
{
	int			edgetableindex;
